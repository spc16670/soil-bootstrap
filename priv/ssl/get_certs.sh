...
function create_certs {
  ...
  openssl req -new -key $1.in.key -out $1.in.csr -subj "/C=UK/ST=Scotland/L=Glasgow/O=IONAS/OU=IS/CN=ionas.co.uk"
  ...
  openssl req -new -x509 -key $1.in.key -out ca.$1.in.crt  -subj "/C=PL/ST=Podkarpacie/L=Frysztak/O=SC/OU=IS/CN=ionas.co.uk"
